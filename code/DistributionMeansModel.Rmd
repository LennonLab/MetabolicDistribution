...
colnames(sddist) <- c("Sd", "Mean","Subsample")

plot(sddist$Sd, log(sddist$Mean[sddist$Subsample == "100"]), col = "red", ylab = "mean", xlab = "sd", pch = 20)
points(sddist$Sd, log(sddist$Mean[sddist$Subsample == "1000"]), col = "blue", pch = 20)
points(sddist$Sd, log(sddist$Mean[sddist$Subsample == "10000"]),col = "green", pch = 20)
