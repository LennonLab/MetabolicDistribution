...
##Figure for MURI Equipment Grant Report
```{r}
#relative abundance
ra_rac_Spo0A_1day_S1 <- process("../data/FCS/EAM_20190403_MURI_1day/Stained_0S1.fcs", "BL1-H", TRUE)
ra_rac_Spo0A_10day_S1 <- process("../data/FCS/EAM_20190403_MURI_10day/Specimen1_1S2.fcs", "BL1-H", TRUE)
...
plot(ra_rac_Spo0A_1day_S1[,1], log(ra_rac_Spo0A_1day_S1[,2]), type = 'p', axes = F, xlab = "", ylab = "", las = 1, cex.lab = 1.25, cex = 0.75, ylim = c(-15,0))
mtext("Rank in activity", side = 1, line = 2, cex = 1.25)
mtext("log(RedoxSensorT Green activity)", side = 2, line = 2.75, cex = 1.25)
...
plot(ra_Cdist_Spo0A_1day_S1[,2], ra_Cdist_Spo0A_1day_S1[,1], type = 'p', axes = F, xlab = "", ylab = "", las = 1, cex.lab = 1.4, cex.axis = 1.25, cex = 0.75)
mtext("% of rank-ordered cells \n contributing to activity", side = 1, line = 3.5, cex = 1.25)
mtext("Cumulative % RedoxSensorT\nGreen activity", side = 2, line = 2.5, cex = 1.25)
...
legend(60,25, c("1 day", "10 day", "100 day"), c("black", "red", "blue"), cex = 0.75)
abline(1,1)
text(90,80, "1:1")
