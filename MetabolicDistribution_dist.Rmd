...
```{r}
JR_100 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/A1_JR_100.fcs")
JR_10 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/B1_JR_10.fcs")
JR_1 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/C1_JR_1.fcs")
JR_100_ATP_10 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/A4_JR_100_ATP_10.fcs")
JR_10_ATP_10 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/B4_JR_10_ATP_10.fcs")
JR_1_ATP_10 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/C4_JR_1_ATP_10.fcs")
JR_100_ATP_5 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/D4_JR_100_ATP_5.fcs")
JR_10_ATP_5 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/A5_JR_10_ATP_5.fcs")
JR_1_ATP_5 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/B5_JR_1_ATP_5.fcs")
JR_100_ATP_1 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/C5_JR_100_ATP_1.fcs")
JR_10_ATP_1 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/D5_JR_10_ATP_1.fcs")
JR_1_ATP_1 <- flowCore::read.FCS(file = "./data/20210713_MetDist_JR_RSG_ATP/A6_JR_1_ATP_1.fcs")

JR_100_ATP_Un <- process("./data/20210713_MetDist_JR_RSG_ATP/A1_JR_100.fcs", "B586-H")
JR_10_ATP_Un <- process("./data/20210713_MetDist_JR_RSG_ATP/B1_JR_10.fcs", "B586-H")
JR_1_ATP_Un <- process("./data/20210713_MetDist_JR_RSG_ATP/C1_JR_1.fcs", "B586-H")
JR_100_ATP_10 <- process("./data/20210713_MetDist_JR_RSG_ATP/A4_JR_100_ATP_10.fcs", "B586-H")
JR_10_ATP_10 <- process("./data/20210713_MetDist_JR_RSG_ATP/B4_JR_10_ATP_10.fcs", "B586-H")
JR_1_ATP_10 <- process("./data/20210713_MetDist_JR_RSG_ATP/C4_JR_1_ATP_10.fcs", "B586-H")
JR_100_ATP_5 <- process("./data/20210713_MetDist_JR_RSG_ATP/D4_JR_100_ATP_5.fcs", "B586-H")
JR_10_ATP_5 <- process("./data/20210713_MetDist_JR_RSG_ATP/A5_JR_10_ATP_5.fcs", "B586-H")
JR_1_ATP_5 <- process("./data/20210713_MetDist_JR_RSG_ATP/B5_JR_1_ATP_5.fcs", "B586-H")
JR_100_ATP_1 <- process("./data/20210713_MetDist_JR_RSG_ATP/C5_JR_100_ATP_1.fcs", "B586-H")
JR_10_ATP_1 <- process("./data/20210713_MetDist_JR_RSG_ATP/D5_JR_10_ATP_1.fcs", "B586-H")
JR_1_ATP_1 <- process("./data/20210713_MetDist_JR_RSG_ATP/A6_JR_1_ATP_1.fcs", "B586-H")

JR_1_ATP_10_CD <- CDist(JR_1_ATP_10[,2])
JR_1_ATP_5_CD <- CDist(JR_1_ATP_5[,2])
JR_1_ATP_1_CD <- CDist(JR_1_ATP_1[,2])
JR_1_CD <- CDist(JR_1_ATP_Un[,2])
...
JR_ATP <- ggplot(JR_100_ATP_Un, aes(x = log(rac), color = "100", fill = "Unstained"))+
  geom_histogram(binwidth = 0.25)+
  geom_histogram(data = JR_10_ATP_Un, aes(x = log(rac), color = "10", fill = "Unstained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_1_ATP_Un, aes(x = log(rac), color = "1", fill = "Unstained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_100_ATP_10, aes(x = log(rac), color = "100", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_10_ATP_10, aes(x = log(rac), color = "10", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_1_ATP_10, aes(x = log(rac), color = "1", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_100_ATP_5, aes(x = log(rac), color = "100", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_10_ATP_5, aes(x = log(rac), color = "10", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_1_ATP_5, aes(x = log(rac), color = "1", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_100_ATP_1, aes(x = log(rac), color = "100", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_10_ATP_1, aes(x = log(rac), color = "10", fill = "Stained"),
                 binwidth = 0.25)+
  geom_histogram(data = JR_1_ATP_1, aes(x = log(rac), color = "1", fill = "Stained"),
                 binwidth = 0.25)+
...
```{r}
PBS_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/A1_PBS.fcs")
Ecoli_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/B1_Ecoli.fcs")
QNA_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/C1_QNA.fcs")
QUE7_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/D1_QUE7.fcs")
QUE2_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/A2_QUE2.fcs")
REXYFP_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/B2_REXYFP.fcs")
Peredox_04 <- flowCore::read.FCS(file = "./data/20210704_MetDist/C2_Peredox.fcs")
summary(PBS_04)
...
```{r}
PBS_04_rac_y615 <- process("./data/20210704_MetDist/A1_PBS.fcs", "Y615-H")
Ecoli_04_rac_y615 <- process("./data/20210704_MetDist/B1_Ecoli.fcs", "Y615-H")
QNA_04_rac_y615 <- process("./data/20210704_MetDist/C1_QNA.fcs", "Y615-H")
QUE7_04_rac_y615 <- process("./data/20210704_MetDist/D1_QUE7.fcs", "Y615-H")
QUE2_04_rac_y615 <- process("./data/20210704_MetDist/A2_QUE2.fcs", "Y615-H")
REXYFP_04_rac_y615 <- process("./data/20210704_MetDist/B2_REXYFP.fcs", "Y615-H")
Peredox_04_rac_y615 <- process("./data/20210704_MetDist/C2_Peredox.fcs", "Y615-H")
...
Peredox <- ggplot(PBS_04_rac_y615, aes(x = log(rac), color = "PBS", fill = "PBS"))+
  geom_histogram(binwidth = 0.25)+
...
ggsave(here("output", "Peredox_04.png"))
ggsave(here("output", "Peredox_04.png"))
```
...
```
#test fitdistr code from Daniel Schwartz
```{r}
library(MASS)
x <- rpois(1000,3)

hst <- hist(x, breaks = 100)
y <- fitdistr(x, "Poisson")
fit <- dpois(hst$mids, y$estimate['lambda'])

plot(x, fit, type="p", ylab="Density", xlab="X", ylim = c(0, max(fit)), xlim = c(0, max(x)))
title(main = "Density histogram with lognormal fit")
lines(hst$mids, hst$counts, type ="l", col="red")
legend(8,0.15,legend=c("Fit","Data"),lty=c(1,1),col=c("black","red"))
```
...
png(filename="./output/MURI.Spo0A_RSG_aaCDF_rare.png",
